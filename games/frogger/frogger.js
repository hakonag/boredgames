...
export function init() {
    ...
    `;
    injectGameStyles('frogger', getGameSpecificStyles());
    if (typeof lucide !== 'undefined') lucide.createIcons();
    
    setupScrollPrevention('frogger');
...
export function cleanup() {
    if (froggerGame) {
        ...
        removeScrollPrevention('frogger');
        removeGameStyles('frogger');
}
...
class FroggerGame {
    ...
    setupControls() {
        this.keys = {};
        this.keyHandler = setupHardReset('frogger', (e) => {

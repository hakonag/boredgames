...
export function init() {
    ...
    window.checkersScrollPrevent = { wheel: preventScroll, touchmove: preventScroll };
...
export function cleanup() {
    ...
    if (window.checkersScrollPrevent) {
        window.removeEventListener('wheel', window.checkersScrollPrevent.wheel);
        window.removeEventListener('touchmove', window.checkersScrollPrevent.touchmove);
        delete window.checkersScrollPrevent;
    }
    const styleEl = document.getElementById('checkers-style');
...
function injectStyles() {
    if (document.getElementById('checkers-style')) return;
    const style = document.createElement('style');
    style.id = 'checkers-style';
    style.textContent = `

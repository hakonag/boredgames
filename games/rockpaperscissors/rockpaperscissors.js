...
export function init() {
    ...
    injectGameStyles('rockpaperscissors', getGameSpecificStyles());
    if (typeof lucide !== 'undefined') lucide.createIcons();
    
    setupScrollPrevention('rockpaperscissors');
...
export function cleanup() {
    ...
    removeScrollPrevention('rockpaperscissors');
    removeGameStyles('rockpaperscissors');
}
...
class RockPaperScissorsGame {
    ...
    setupControls() {
        this.keyHandler = setupHardReset('rockpaperscissors', (e) => {

...
export function init() {
    ...
    `;
    injectGameStyles('reversi', getGameSpecificStyles());
    if (typeof lucide !== 'undefined') lucide.createIcons();
    
    setupScrollPrevention('reversi');
...
export function cleanup() {
    if (reversiGame) {
        ...
        removeScrollPrevention('reversi');
        removeGameStyles('reversi');
}
...
class ReversiGame {
    ...
    setupControls() {
        this.keyHandler = setupHardReset('reversi', (e) => {
